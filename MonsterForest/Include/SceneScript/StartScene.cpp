...
bool CStartScene::Init()
{
...

	{
		...
		pButton->SetCallback(this, &CStartScene::login_JOIN_callback);
...

	{

		{
			...
			pButton->SetCallback(this, &CStartScene::login_ID_callback);
			SAFE_RELEASE(pButton);
...

		{
			...
			pButton->SetCallback(this, &CStartScene::login_PW_callback);
			SAFE_RELEASE(pButton);
...
void CStartScene::login_ID_callback(float fTime)
{
	this->id_write = true;
	this->pw_write = false;
...
void CStartScene::login_PW_callback(float fTime)
{
	this->id_write = false;
	this->pw_write = true;
}

void CStartScene::login_JOIN_callback(float fTime)
{

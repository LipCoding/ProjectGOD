	...
	bool bWindowMode)
{
	...
	CreateTextFormat("¸¼Àº°íµñ25N", L"¸¼Àº °íµñ25N", DWRITE_FONT_WEIGHT_DEMI_BOLD,
		DWRITE_FONT_STYLE_NORMAL, DWRITE_FONT_STRETCH_ULTRA_EXPANDED, 25.F, L"ko", DWRITE_TEXT_ALIGNMENT_LEADING, DWRITE_PARAGRAPH_ALIGNMENT::DWRITE_PARAGRAPH_ALIGNMENT_NEAR);

...
typedef struct PG_DLL _tagKeyFrame
{
	double	dTime;
	Vector3	vPos;
	Vector3	vScale;
...
typedef struct PG_DLL _tagBoneKeyFrame
{
	int		iBoneIndex;
	vector<PKEYFRAME>	vecKeyFrame;
}BONEKEYFRAME, *PBONEKEYFRAME;

typedef struct PG_DLL _tagAnimationCallback
{
...
typedef struct PG_DLL _tagAnimation3DClip
{

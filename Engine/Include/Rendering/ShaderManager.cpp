...
bool CShaderManager::Init()
{
	...
	pEntry[ST_VERTEX] = "ShadowMapVS";
	pEntry[ST_PIXEL] = "ShadowMapPS";
	pEntry[ST_GEOMETRY] = NULL;
	pShader = LoadShader(SHADOWMAP_SHADER, L"LandScape.fx",
		pEntry);

	SAFE_RELEASE(pShader);

	pEntry[ST_VERTEX] = "ShadowStaticObjectVS";
	pEntry[ST_PIXEL] = "ShadowCharacterPS";
	pEntry[ST_GEOMETRY] = NULL;
	pShader = LoadShader(SHADOWSTATICOBJECT_SHADER, L"Standard.fx",
		pEntry);

	SAFE_RELEASE(pShader);

	pEntry[ST_VERTEX] = "ShadowCharacterVS";
	pEntry[ST_PIXEL] = "ShadowCharacterPS";
	pEntry[ST_GEOMETRY] = NULL;
	pShader = LoadShader(SHADOWCHARACTER_SHADER, L"Standard.fx",
		pEntry);
	...
	pEntry[ST_VERTEX] = "StandardTexNormalVS";
	pEntry[ST_PIXEL] = "StandardShadowTexNormalPS";
	pEntry[ST_GEOMETRY] = NULL;
	pShader = LoadShader(STANDARD_SHADOWMAP_TEXNORMAL_SHADER, L"Standard.fx",
		pEntry);
	...
	pEntry[ST_PIXEL] = "StandardShadowTexNormalPS";
	pEntry[ST_GEOMETRY] = NULL;
	pShader = LoadShader(STANDARD_SHADOWMAP_TEXNORMALANIM_SHADER, L"Standard.fx",
		pEntry);

	SAFE_RELEASE(pShader);

	pEntry[ST_VERTEX] = "StandardBumpVS";
	pEntry[ST_PIXEL] = "StandardShadowBumpPS";
	pEntry[ST_GEOMETRY] = NULL;
	pShader = LoadShader(STANDARD_SHADOWMAP_BUMP_SHADER, L"Standard.fx",
		pEntry);
	...
	pEntry[ST_PIXEL] = "StandardShadowBumpPS";
	pEntry[ST_GEOMETRY] = NULL;
	pShader = LoadShader(STANDARD_SHADOWMAP_BUMPANIM_SHADER, L"Standard.fx",
		pEntry);

	SAFE_RELEASE(pShader);

	pEntry[ST_VERTEX] = "StandardColorVS";
	pEntry[ST_PIXEL] = "StandardShadowColorPS";
	pEntry[ST_GEOMETRY] = NULL;
	pShader = LoadShader(STANDARD_SHADOWMAP_COLOR_SHADER, L"Standard.fx",
		pEntry);

	SAFE_RELEASE(pShader);

	pEntry[ST_VERTEX] = "StandardColorNormalVS";
	pEntry[ST_PIXEL] = "StandardShadowColorNormalPS";
	pEntry[ST_GEOMETRY] = NULL;
	pShader = LoadShader(STANDARD_SHADOWMAP_COLORNORMAL_SHADER, L"Standard.fx",
		pEntry);
	...
	CreateInputLayout("ShadowStaticObject", SHADOWSTATICOBJECT_SHADER);
	...
	CreateInputLayout("ShadowCharacterAnim", SHADOWCHARACTER_SHADER);
	...
	CreateInputLayout("ShadowVertexPos", SHADOWMAP_SHADER);

...
typedef struct PG_DLL _tagBone
{
	string		strName;
	int			iDepth;
	int			iParentIndex;
...
typedef struct PG_DLL _tagAnimationChannel
{
...
public:
	...
	bool SetSocketTarget(const string& strBoneName, const string& strSocketName,
		class CGameObject* pTarget);

...
public:
	...
	void LoadGlobLight(const string& strFileName, const Vector4& ambient = Vector4(1.f, 1.f, 1.f, 1.f));
	void LoadPointLight(const string& strFileName, const Vector4& ambient = Vector4(1.f, 1.f, 1.f, 1.f));
public:

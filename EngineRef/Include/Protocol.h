...
const unsigned char CS_PACKET_ATTACK_SKILL4 = 54;
const unsigned char CS_PACKET_ATTACK_SKILL1_EFFECT = 70;
const unsigned char CS_PACKET_ATTACK_SKILL2_EFFECT = 71;
const unsigned char CS_PACKET_ATTACK_SKILL3_EFFECT = 72;
const unsigned char CS_PACKET_ATTACK_SKILL4_EFFECT = 73;
...
const unsigned char SC_PACKET_ATTACK_SKILL2_EFFECT = 71;
const unsigned char SC_PACKET_ATTACK_SKILL3_EFFECT = 72;
const unsigned char SC_PACKET_ATTACK_SKILL4_EFFECT = 73;

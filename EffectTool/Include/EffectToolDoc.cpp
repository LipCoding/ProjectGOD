...
CEffectToolDoc::CEffectToolDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CEffectToolDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CEffectToolDoc::InitializeSearchContent()
{
...
void CEffectToolDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
